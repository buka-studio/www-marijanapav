  ...
  return (
    <>
      <Dialog.Root open={Boolean(effect)} onOpenChange={onClose} modal={false}>
        ...
        <Dialog.Content className="effects-content fixed top-1/2 left-1/2 z-10 h-full w-full -translate-x-1/2 -translate-y-1/2 bg-white/70 in-[.theme-dark]:bg-black/50">
          <Dialog.Close className="fixed top-5 right-5 z-10 text-lg" asChild>
