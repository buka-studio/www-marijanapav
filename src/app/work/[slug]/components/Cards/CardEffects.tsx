  ...
  return (
    <>
      <Dialog.Root open={Boolean(effect)} onOpenChange={onClose} modal={false}>
        <Dialog.Overlay className="effects-overlay fixed inset-0 bg-white [.theme-dark_&]:bg-black" />
        <Dialog.Content className="effects-content fixed left-1/2 top-1/2 z-10 h-full w-full -translate-x-1/2 -translate-y-1/2 bg-white/70 [.theme-dark_&]:bg-black/50">
